...
" sets z<enter> to 1 line below top
  set scrolloff=1
  set lbr

" Use X11 clipboard for yanking and putting
...
" Allows for searching into subdirectories
  set path+=**
...
""" CUSTOM MAPPINGS
" Shortcuts for window navigation. Why the default setting is the way it is
" currently is mind-boggling
  map <C-h> <C-w>h
  map <C-j> <C-w>j
  map <C-k> <C-w>k
  map <C-l> <C-w>l
...
""" VIMWIKI SETTINGS
  let g:vimwiki_list = [{'path': '~/docs/vimwiki/', 'index': 'index', 'auto_toc': 1, 'syntax': 'markdown', 'ext': '.md'}]

" NOT WORKING
" :map <Leader>tc <Plug>VimwikiTOC
" :nmap <Leader>dt <Leader>dt <Plug>VimwikiTabMakeDiaryNote
